...
namespace Treehouse.FitnessFrog.Models
{
    ...
    public class Entry
    {
        ...
        /// </summary>
        [Range(1,10000, ErrorMessage = "La duración debe ser mayor que cero y menor que diez mil.")]
        ...
        /// </summary>
        [MaxLength(200, ErrorMessage = "La nota no puede ser mayor de 200 caracteres.")]
